...
class Ui_ControlForm(object):
    ...
    def retranslateUi(self, ControlForm):
        ...
        self.lineSource1.setToolTip(
            _translate(
                "ControlForm",
                "<html><head/><body><p>Source to compare can be:</p><p>  - path "
                + "to a back-up directory</p><p>  - a network interface &lt;"
        ...
        self.pushDownload.setToolTip(
            _translate(
                "ControlForm",
                "<html><head/><body><p>Copied the specified built projects into"
                + " the active project site of the Power PMAC (/var/ftp/usrflash"
                + "/Project) and then loads it into active memory.</p></body></html>",
            )
        )
        ...
        self.pushRecover.setToolTip(
            _translate(
                ...
                + " Project, Database and Temp directories which have been copied"
                + " from the /opt/ppmac/usrflash site on the Power PMAC are copied"
                + " back into that site and the Project will become active upon power"
                + " cycling the Power PMAC.</p></body></html>",
            )
        )
